...
/**
 * StartServiceServiceHandler<p/>Responsible for starting/stopping the monitoring service.<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-01-18
 */
public abstract class StartServiceServiceHandler extends PersistenceServiceHandlerSupport implements ServiceHandler,
        PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.monitor.impl.service.StartServiceServiceHandler";

    /** Constructs a new StartServiceServiceHandler instance. */
    public StartServiceServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<EmptyServiceMessage> invoke(ServiceRequest<EmptyServiceMessage> rq)
        ...
        try {
            ...
            msg = this.startService(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws MonitorException
     */
    protected abstract EmptyServiceMessage startService(EmptyServiceMessage msg) throws MonitorException;
