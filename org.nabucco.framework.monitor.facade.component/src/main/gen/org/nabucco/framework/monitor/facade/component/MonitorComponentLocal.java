...
/**
 * MonitorComponentLocal<p/>Component for monitoring and management operations.<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-01-18
 */
public interface MonitorComponentLocal extends MonitorComponent {
    ...
    /**
     * Getter for the MonitorServiceLocal.
     *
     * @return the MonitorService.
     * @throws ServiceException
     */
    MonitorService getMonitorServiceLocal() throws ServiceException;
}
